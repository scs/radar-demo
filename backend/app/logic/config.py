...
class StaticConfig:
    ...
    period_in_seconds: NDArray[np.int32] = np.array([3, 4, 6, 12])
    number_of_steps_in_period: NDArray[np.int32] = frame_rate_per_second * period_in_seconds
    static_stopped_image: Image.Image = Image.open(STOPPED_IMG)
    iter: int = 0
